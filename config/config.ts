...
export default defineConfig({
  ...
  locale: {
    ...
    default: 'zh-CN',
    antd: true,
    // Chinese is the product default and must not be overridden by the browser.
    baseNavigator: false,
  },
  /**
   * @name antd 插件
    ...
    configProvider: {
      ...
      theme: {
        token: {
          ...
          borderRadiusLG: 6,
          boxShadow:
            '0 12px 32px rgba(16, 24, 40, 0.10), 0 3px 10px rgba(16, 24, 40, 0.06)',
          boxShadowSecondary:
            '0 8px 24px rgba(16, 24, 40, 0.08), 0 2px 6px rgba(16, 24, 40, 0.05)',
          boxShadowTertiary:
            '0 1px 2px rgba(16, 24, 40, 0.035), 0 4px 12px rgba(16, 24, 40, 0.025)',
          fontFamily:
